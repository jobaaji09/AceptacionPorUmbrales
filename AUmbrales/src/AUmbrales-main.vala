namespace Aumbrales{
    class Main : GLib.Object {
        ...
        public static int main(string[] args){
			...
			//for(int j =1 ; j<200;j++){
			var s = new Aceptacion.Solucion(h,93,10);
			...
			var a = new Aumbrales(s, 500, 0.85, 0.002, 0.004);
			//var t = a.temperaturaInicial(sini,8,0.85);
			a.aceptacionPorUmbrales(7,sini);
			string ou = "";
			...
			try {
				...
				var file = File.new_for_path ("experimentos/"+93.to_string()+".tsp");
